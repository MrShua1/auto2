...
function check() {
  ...
  try {
    ...
    verifyIntegrity();
    return { bundleIntegrity: true, files: count, internalModules: modules.length, imageTests: true, autoTests: true, integrationTests: true, bundleSafetyTests: true, liveApi: 'NOT_TESTED', credentials: 'NOT_BUNDLED', currentHostToolRegistration: 'UNKNOWN_NOT_MEASURED', hostRegistrationChecked: false, platform: 'win32-x64' };
