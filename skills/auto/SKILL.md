...
### 9. 【介质穿透连续运镜与水下渐进显露铁律（Rule 0.13）】
- **禁止单镜头跨介质双场景重叠（Anti-Double-Exposure Purge）**：严禁在单镜头内同时绑定海面/海滩与海底深海场景并要求原地透视！大模型必然产生双重曝光，海底生物悬空贴在海面上。
- **介质穿透物理运镜五段式闭环**：
  * **镜头 A（起因 · 客观神态反应）**：面部极近景，双目金芒爆发，双唇紧闭，海滩环境（2.5~3.5s）；
  * **镜头 B（穿透 · 主观视线潜入与显露 POV）**：**严格 0 人物卡（杜绝水下浮空人脸）**，镜头跟随视线向前下方急速俯冲推进，平滑切入水面扎入水中，伴随浪花与气泡消散，在水下继续下潜推进，丁达尔光束照射下景深远处逐渐清晰显露海底暗流、礁石与游鱼；台词转为**画外音（O.S.）**（4.0~5.0s）；
...
- **自动化门禁一票否决**：单镜头同时出现海面与海底但缺少主观穿透推进动作且包含人物身体的，门禁直接阻断报错。
