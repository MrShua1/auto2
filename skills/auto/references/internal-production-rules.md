...
0.13 【异能视线光学穿透与景深聚焦铁律 · 严禁实体入水扰动与物理水体形变（Optical Gaze Penetration & Anti-Physical-Disturbance Gate）】：
   - **【最高绝对红线：严禁单镜头跨介质双场景静态图层叠加（Zero Cross-Medium Double Exposure Gate）】**：
     * 严禁在同一单镜头的【主体】/【主体锁】中，同时强行绑定“水面/陆地场景（如海滩、海面）”与“深海/水下场景（如海底暗流、礁石珊瑚）”并指望模型“原地透视”！
     * 多模态扩散视频模型（Wan 2.1/Wan 3.0/Kling/Seedance）在单镜头同时接收海面与海底场景提示时，缺乏真实的物理三维透视理解，必然将其渲染为**双重曝光/图层叠印（Naïve Double Exposure / Alpha Blend）**，导致海底生物、珊瑚与礁石直接悬空贴在海浪水面上，造成严重视觉穿帮与交付事故；
   - **【最高绝对红线：严禁将视线穿透伪造为实体物体入水扰动与物理水体变色（Zero Physical Disturbance & Invariant Water Body Gate）】**：
     * **视线轨迹是虚拟光学焦点纵深推移，绝非实体入水！** 视线穿透水体不会发生任何水力学冲撞！严禁在提示词中描写“伴随浪花与气泡向两侧划开散去”、“破水浪花飞溅”、“扎入水面”、“水花炸裂”等实体摄像机/潜水员砸入水中的假动作；任何写出此类词汇的，直接触发白沫遮蔽视线的严重穿帮与门禁一票否决；
     * **海水是客观静态的物理介质，视线穿透绝不会导致水质与水体物理改变！** 严禁描写“水体由表层的泛白晨浪逐渐过渡为通透纯澈的碧蓝色”等将水体本身拟态变形变色的伪物理词；海水客观保持澄澈静谧，真正发生变化的是**主观视线焦点（Focal Point）自海面反光层向深海暗处的纵深推移与合焦锐化（Progressive Focal Penetration & Depth-of-Field Refocusing）**；
   - **【影视级主观视线穿透视听语言物理链（The Optical Gaze Penetration POV Syntax）】**：
     * 凡原著剧本涉及“从陆地/海面看穿到水下/深海海底（如水眼金睛开眼看透海水、声呐透视、肉眼窥测暗礁游鱼）”的情节，**必须且只能通过主观光学焦点推移与时序分镜头递进呈现**：
       ① **镜头 A（起因 · 客观神态反应镜头 / Objective Reaction Shot）**：
          - 景别与机位：面部极近景/特写（Close-Up / ECU），平视微仰，主角处于海面/海滩环境；
          - 物理动作：双目紧闭到猛然睁开金芒爆发，双唇严密闭合；目光如炬斜向下聚焦射向海面；
          - 资产锁：仅包含人物（{{Mixed 1}}）与海面/海滩（{{Mixed 2}}），严禁连入水下资产；
       ② **镜头 B（穿透 · 主观视线光学穿透与景深合焦镜头 / Subjective Optical Gaze Penetration POV Shot）**：
          - 景别与机位：**纯第一人称主观异能透视视角（Subjective Divine Vision POV Shot）**，**严格 0 人物资产锁（严禁连入 Mixed 1，杜绝水下浮空人脸/躯干畸变）**；
          - 运镜与焦点推移：镜头模拟双目金芒视线焦点向前下方急速纵深推移（Forward focal push-in & depth penetration），视线瞬间穿透海面表层的自然反光与波光虚影；
          - 物理介质守恒：水体客观保持自然静谧与澄澈，**绝对零水力扰动，严禁出现浪花破裂与气泡划开散开**；
          - 景深合焦过程：镜头景深（Depth of Field）随视线焦点无阻碍下沉穿透水体，焦点直接落在深海景深处，在水下微弱光影与自然水色中，原本隐匿于深处的自然海底暗流、嶙峋礁石与游弋的野生海鱼群在视线落点处精准锐化合焦、由虚变实显露全貌；
          - 物理机位带动揭示：由主观视线焦点的纵深推移带动画面合焦显露，严禁原地静态图层淡入叠加；
          - 声画解耦：人物宣泄台词必须作为**画外音（O.S.）**配音，画面纯水下无人物，双唇严密闭合，规避口型驱动穿帮；
       ③ **镜头 C（承接 · 客观震惊反应镜头 / Objective Reaction Shot，可选但推荐）**：
          - 切回海滩/船头人物中近景，手抚眼眶面露震撼狂喜，与朝阳/海风辉映；
       ④ **镜头 D（目标 · 水下特写镜头 / Submerged POV Target Shot，若有具体目标道具）**：
          - 纯水下环境（{{Mixed 3}}），中景/特写聚焦目标道具（{{Mixed 4}}，如极品幽蓝斑在珊瑚丛中从容巡游），无海面元素干扰；
       ⑤ **镜头 E（立誓 · 客观行动/立誓镜头 / Objective Resolution Shot）**：
          - 切回海滩客观中全景，主角挺拔站立迎风，宣布目标决心；
   - **【单镜头黄金时长与单一物理动量定律（Shot Duration Budget & Single Physical Action Rule）】**：
     * 短剧单镜头时长严格锁定在 **2.5 秒 ~ 5.0 秒**，严禁生成 8~10 秒臃肿大单镜头；
     * 视线光学穿透镜头（镜头 B）时长控制在 4.0~5.0 秒，刚好支撑“水面反光聚焦 -> 视线无阻穿透 -> 景深下沉合焦 -> 锐化显露暗流礁石与鱼群”的完整视觉聚焦过程；
   - **【自动化门禁校验与一票否决（Optical Penetration Semantic Linter Gate）】**：
     * 校验器在提示词审查时执行深度语意检查：
       1. 凡单个镜头同时声明“海滩/海面/陆地”与“海底/深海/水下”场景资产，但未声明主观穿透运镜（如“镜头跟随视线前推”、“第一人称主观视角”、“穿透”）且仍包含人物身体站立动作的，一律定性为双重曝光违规穿帮，门禁立即阻断（Exit 1）；
       2. 凡在视线透视/穿透镜头中出现“浪花气泡”、“气泡向两侧”、“划开散去”、“破水浪花”、“水体由.*过渡”等违规实体扰动与水体形变词汇的，一律判定为违规穿帮假动作，门禁立即阻断（Exit 1）。
